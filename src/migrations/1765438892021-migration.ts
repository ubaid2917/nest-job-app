...
export class Migration1765438892021 implements MigrationInterface {
    name = 'Migration1765438892021'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_role_enum" AS ENUM('candidate', 'employer')`);
